...
const TITLE_PHRASES: Array<[RegExp | string, string]> = [
  ...
  [/# of CRA seats after the 2026 Japanese snap election\?/gi, "2026年衆院選後の中道改革連合の獲得議席数は？"],
  ...
  [/Will CRA win 173\+ seats in the Japanese snap election\?/gi, "衆院選で中道改革連合は173議席以上獲得する？"],
